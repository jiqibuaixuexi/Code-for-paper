...
class Block(nn.Layer):
    ...
    def __init__(self, dim, drop_path=0., layer_scale_init_value=1e-6):
        ...
        self.gamma = paddle.create_parameter(shape=[dim], dtype=paddle.float32,
                                             default_initializer=paddle.nn.initializer.Assign(layer_scale_init_value * paddle.ones((dim, ))),
...
class ConvNeXt(nn.Layer):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
                 ...
                 layer_scale_init_value=1e-6, head_init_scale=1.,activations = True
                 ):
        super().__init__()
...
class LayerNorm(nn.Layer):
    ...
    def __init__(self, normalized_shape, epsilon=1e-6, data_format="channels_last"):
        super().__init__()
        self.weight = paddle.create_parameter(shape=[normalized_shape], dtype=paddle.float32,
                                              default_initializer=paddle.nn.initializer.Assign(paddle.ones((normalized_shape,))))
        self.bias = paddle.create_parameter(shape=[normalized_shape], dtype=paddle.float32,
                                              default_initializer=paddle.nn.initializer.Assign(paddle.zeros((normalized_shape,))))
