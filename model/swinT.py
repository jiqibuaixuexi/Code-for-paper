...
def swin_ti(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load('data/data80934/swin_tiny_patch4_window7_224.pdparams'))
    return model
...
def swin_s(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load('data/data80934/swin_small_patch4_window7_224.pdparams'))
    return model
...
def swin_b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load('data/data80934/swin_base_patch4_window7_224.pdparams'))
    return model
...
def swin_b_384(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.set_dict(paddle.load('data/data80934/swin_base_patch4_window12_384.pdparams'))
    return model    
